...
import 'package:contacts/ui/pages/favorites/favorites.page.dart';
import 'package:contacts/ui/pages/home/home.page.dart';
import 'package:contacts/ui/pages/label/label.page.dart';
...
abstract final class AppRoutes {
  ...
  static String label(String id) => '/etiquette/$id';
}
...
GoRouter goRouter(Ref ref) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/etiquette/:id',
        builder: (_, state) => LabelPage(labelId: state.pathParameters['id']!),
      ),
